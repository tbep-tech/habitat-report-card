...
format:
  html:
    theme: cosmo
    code-tools: 
      source: https://github.com/tbep-tech/habitat-report-card/blob/master/docs/habitatreportupdates.qmd
    css: styles.css
...
## Tabular summary of coverage changes
...
## Graphical summary of coverage changes
