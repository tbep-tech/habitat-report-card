...
Using the current oyster coverage, the following table shows the percent increase (or decrease) in oyster coverage to achieve thresholds under both options.
